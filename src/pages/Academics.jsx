            ...
            return (
              ...
              >
                ...
                <div className="flex justify-center mb-5">
                  <div
                    className="p-4 sm:p-5 rounded-full bg-gradient-to-tr from-[#006D77] to-[#FF6B6B] 
                ...
                {/* Title */}
                <h3 className="text-base sm:text-xl font-semibold text-[#006D77] mb-2 sm:mb-3 font-poppins group-hover:text-[#FF6B6B] transition-all duration-300">
                  {program.title}
                </h3>
